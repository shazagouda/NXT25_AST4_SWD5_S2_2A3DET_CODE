...
namespace A3DET_CODE.Migrations
{
    ...
    [Migration("20260717180228_AddDismissedNotifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("A3DET_CODE.Models.ChatGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("A3DET_CODE.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("A3DET_CODE.Models.ChatUserGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("A3DET_CODE.Models.DismissedNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("A3DET_CODE.Models.ChatMessage", b =>
                {
                    b.HasOne("A3DET_CODE.Models.ChatGroup", "Group")
                        .WithMany("Messages")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("A3DET_CODE.Models.ApplicationUser", "Sender")
                        .WithMany()
