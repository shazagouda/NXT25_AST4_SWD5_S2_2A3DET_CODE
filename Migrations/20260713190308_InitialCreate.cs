    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntryAssessments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EntryAssessments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedInUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProfileStrength = table.Column<int>(type: "int", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssessmentQuestions_Tracks_TrackId",
                        column: x => x.TrackId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssessmentResults_Tracks_TrackId",
                        column: x => x.TrackId,
                        principalTable: "Tracks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserBadges_Portfolios_PortfolioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PortfolioProject_Portfolios_PortfolioId",
                        column: x => x.PortfolioId,
                        principalTable: "Portfolios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssessmentQuestions_TrackId",
                table: "AssessmentQuestions",
                column: "TrackId");

            migrationBuilder.CreateIndex(
                name: "IX_AssessmentResults_TrackId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PortfolioProject_PortfolioId",
                table: "PortfolioProject",
                column: "PortfolioId");

            migrationBuilder.CreateIndex(
                name: "IX_PortfolioProject_ProjectId",
                table: "PortfolioProject",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBadges_PortfolioId",
                table: "UserBadges",
                column: "PortfolioId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_PortfolioProject_Projects_ProjectId",
                table: "PortfolioProject",
                column: "ProjectId",
                principalTable: "Projects",
                principalColumn: "Id",
